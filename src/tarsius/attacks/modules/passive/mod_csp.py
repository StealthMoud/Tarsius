...
from tarsius.network.csp_utils import csp_header_to_dict, CSP_CHECK_LISTS, check_policy_values
from tarsius.definitions.csp import CspFinding
from tarsius.utils.log import log_red
from tarsius.language.vulnerability import LOW_LEVEL, MEDIUM_LEVEL
