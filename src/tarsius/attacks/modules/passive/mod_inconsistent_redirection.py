...
from tarsius.definitions.inconsistent_redirection import InconsistentRedirectionFinding
from tarsius.language.vulnerability import MEDIUM_LEVEL
from tarsius.utils.log import log_orange
