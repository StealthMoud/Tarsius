...
from tarsius.definitions import FindingBase
...
from tarsius.language.vulnerability import (
    CRITICAL_LEVEL,
    HIGH_LEVEL,
    MEDIUM_LEVEL,
    LOW_LEVEL,
...
from tarsius.mutation.json_mutator import get_item, set_item, find_injectable
...
class Attack(AttackProtocol):
    ...
    DATA_DIR = str(files("tarsius").joinpath("data", "attacks"))
    ...
    def dns_endpoint(self):
        return self.options.get("dns_endpoint", "dns.tarsius3.ovh")

    @property
    def internal_endpoint(self):
        return self.options.get("internal_endpoint", "https://tarsius3.ovh/")

    @property
    def external_endpoint(self):
        return self.options.get("external_endpoint", "http://tarsius3.ovh/")
    ...
    def wapp_url(self):
        return self.options.get(
            "wapp_url",
            "https://raw.githubusercontent.com/tarsius-scanner/wappalyzerfork/main/",
        )
