...
from tarsius.language.vulnerability import CRITICAL_LEVEL, HIGH_LEVEL, MEDIUM_LEVEL, LOW_LEVEL
...
def cvss_score_to_tarsius_level(cvss_score: float):
    """Returns the Tarsius alert level for a CVSS score. It is based on CVSS v3 Ratings."""
    if cvss_score < 3.9:
        return LOW_LEVEL
    if cvss_score < 6.9:
        return MEDIUM_LEVEL
