...
from tarsius.utils.log import logging, log_verbose, log_red
from tarsius.attacks.attack import Attack, random_string
from tarsius.definitions.dangerous_resource import DangerousResourceFinding
...
class ModuleNikto(Attack):
    ...
    name = "nikto"
    NIKTO_DB = "nikto_db"
    NIKTO_DB_URL = "https://raw.githubusercontent.com/tarsius-scanner/nikto/master/program/databases/db_tests"
