...
from tarsius.utils.log import logging
from tarsius.network.crawler import Response
...
class ApplicationData:
    ...
    For instance https://raw.githubusercontent.com/tarsius-scanner/wappalyzerfork/master/src/technologies/.
    """
    ...
    def __init__(self, categories_file_path=None, groups_file_path=None, technologies_file_path=None):
        ...
        """
        base_dir = os.path.join(os.getenv("HOME") or os.getenv("USERPROFILE") or "/home", ".tarsius")
    ...
    def normalize_application_regex_dom(dom : dict) -> dict:
        """
        Convert the result of wappalyzer to a generic format used by Tarsius.
        ...
        The list contains only one item same as the idct contains only one key to fit with the tarsius format.
