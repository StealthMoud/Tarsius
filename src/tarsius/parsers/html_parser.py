...
# Internal libraries
from tarsius import parser_name
from tarsius.network import Request, make_absolute
from tarsius.parsers.javascript import extract_js_redirections
...
AUTOFILL_VALUES = {
    ...
    "email": "tarsius2021@mailinator.com",
    ...
    "textarea": "Hi there!",
    "time": "13:37",
    "url": "https://tarsius-scanner.github.io/",
    "username": "alice",
    "week": "2019-W24"
}
...
class HtmlForm:
    ...
    def to_requests(self) -> List[Request]:
        """
        Converts the HtmlForm into a list of Tarsius Request objects,
