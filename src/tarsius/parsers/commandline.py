...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description=f"Tarsius {TARSIUS_VERSION}: Web application vulnerability scanner")
    ...
    group.add_argument(
        "--list-modules",
        action="store_true",
        help="List Tarsius attack modules and exit"
    )
    ...
    group.add_argument(
        "--update",
        action="store_true",
        help="Update Tarsius attack modules and exit"
    )
